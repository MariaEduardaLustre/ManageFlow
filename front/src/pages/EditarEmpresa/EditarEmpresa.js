...
import { FaBuilding, FaIdCard, FaEnvelope, FaHome, FaHashtag, FaStar, FaQrcode, FaLink, FaCopy, FaDownload, FaTimes, FaGlobeAmericas, FaImage, FaUpload } from 'react-icons/fa';
      ...
      <>
        <div className="editar-empresa-container">
          ...
          <Container as="main" className="editar-empresa-main-content">
            ...
            <Alert variant="secondary">Carregando…</Alert>
          </Container>
        </div>
      </>
    );
